<template>
  <div id="product-2" class="py-[20px] flex flex-col xl:flex-row xl:py-[270px] relative">
    <div class="image xl:absolute xl:order-2 xl:right-0 xl:top-0 xl:bottom-0 xl:margin-auto xl:w-2/3">
      <nuxt-img
